...
extension GetFolderCollection on Isar {
  IsarCollection<Folder> get folders => collection();
}

const FolderSchema = CollectionSchema(
  name: r'Folder',
  schema:
      r'{"name":"Folder","idName":"id","properties":[{"name":"created","type":"Long"},{"name":"description","type":"String"},{"name":"title","type":"String"}],"indexes":[],"links":[]}',
  idName: r'id',
  propertyIds: {r'created': 0, r'description': 1, r'title': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {},
...
void _folderSerializeNative(IsarCollection<Folder> collection, IsarCObject cObj,
    Folder object, int staticSize, List<int> offsets, AdapterAlloc alloc) {
...
Object _folderSerializeWeb(IsarCollection<Folder> collection, Folder object) {
...
Folder _folderDeserializeWeb(IsarCollection<Folder> collection, Object jsObj) {
  final object = Folder();
...
void _folderAttachLinks(IsarCollection<dynamic> col, int id, Folder object) {}
